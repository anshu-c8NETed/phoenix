...
function AgentsShowcase() {
  ...
  return (
    <section className="w-full py-12 md:py-16 px-4 md:px-8 relative" style={{ borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col relative">
          ...
          <div className="absolute left-[19px] md:left-[25px] top-2 bottom-2 w-px pointer-events-none" style={{ background: "linear-gradient(to bottom, rgba(239,68,68,0.2), rgba(96,165,250,0.2), rgba(167,139,250,0.2))" }} />
    ...
    >
      {isAnon ? (
        <button
          ...
          className="flex items-center gap-1.5 text-[10px] font-mono text-zinc-500 hover:text-zinc-300 border border-zinc-800 hover:border-zinc-600 bg-zinc-900/60 hover:bg-zinc-800/80 px-2.5 py-1.5 rounded-lg transition-all disabled:opacity-50"
        >
          {/* Google G icon */}
        ...
        <div
          ...
          className="flex items-center gap-1.5 text-[10px] font-mono text-emerald-500/80 border border-emerald-500/20 bg-emerald-950/20 px-2.5 py-1.5 rounded-lg"
        >
          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 flex-shrink-0" />
          {user.displayName?.split(" ")[0] || "Signed in"}
          <span className="text-emerald-700">· ☁ Firebase</span>
        </div>
      )}
    </motion.div>
  );
  ...
  return (
    <div className="min-h-screen text-zinc-100 selection:bg-red-500 selection:text-white" style={{ background: "#050507" }}>
      ...
      <div className="relative z-10">
        ...
        <header className="phoenix-header">
          <div className="max-w-5xl mx-auto px-4 md:px-8 py-4 flex items-center justify-between gap-3">
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="w-px h-4 bg-zinc-800 flex-shrink-0" />
              <div className="p-1.5 rounded-xl shadow-lg flex-shrink-0" style={{ background: "linear-gradient(135deg, #EF4444, #F97316)", boxShadow: "0 0 16px rgba(239,68,68,0.4)" }}>
                <Flame className="w-4 h-4 text-white" />
              </div>
              <h1 className="text-lg font-bold flex-shrink-0" style={{ background: DS.fireGradient, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Phoenix</h1>
          ...
          <AnimatePresence>
            {intelligence && (
              <motion.section ref={resultsSectionRef} initial={{ opacity: 0, y: 25 }} animate={{ opacity: 1, y: 0 }} transition={{ type: "spring", stiffness: 100, damping: 15 }}
                className="mt-10 rounded-2xl p-4 sm:p-6 shadow-2xl relative overflow-hidden text-left"
                style={{
                  background: "rgba(8,8,12,0.8)",
                  backdropFilter: "blur(24px)",
                  WebkitBackdropFilter: "blur(24px)",
                  border: "1px solid rgba(255,255,255,0.06)",
                  boxShadow: "0 1px 0 rgba(255,255,255,0.03) inset, 0 25px 80px rgba(0,0,0,0.6)",
                }}>
        ...
        <footer className="text-center text-[10px] text-zinc-700 font-mono tracking-wide py-10" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          Phoenix — Last Minute Life Saver · 6 AI Agents · Gemini Powered · Any deadline. Any crisis. Right now.
        </footer>
      </div>
    </div>
  );
